...
$idOportunidad = $_GET['id'];
$oportunidad = $database->oportunidades->findOne([
    '_id' => new ObjectId($idOportunidad)
]);

session_start();
$nombreVoluntario = $_SESSION['usuario']['nombre'] ?? 'Voluntario';
$nombreOrg = $oportunidad['nombre_organizacion'] ?? 'Organización';
...
$logoBase64 = base64_encode(file_get_contents(__DIR__ . '/../img/logo.png')); // Asegúrate que la ruta sea correcta
$logoSrc = 'data:image/png;base64,' . $logoBase64;

// HTML del certificado con logo
$html = '
<!DOCTYPE html>
<html lang="es">
<head>
